\subsection{Encoding} \label{seq:encoding}
...
\paragraph{unfinished} ladiela, niet af, problemen sylvan, veel gezeur met
alles aan het werk krijgen

\paragraph{reachability} geen analysis

\paragraph{Couner examples} hebben we niet, ook als implementatie wel af, dan
